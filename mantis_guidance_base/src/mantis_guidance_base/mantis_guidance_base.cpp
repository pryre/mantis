...
MantisGuidanceBase::MantisGuidanceBase() :
	...
	dyncfg_control_settings_.setCallback(boost::bind(&MantisGuidanceBase::callback_cfg_control_settings, this, _1, _2));
	...
	if( p_.wait_for_params() && s_.wait_for_state() ) {
		...
		timer_ = nhp_.createTimer(ros::Duration(1.0/param_path_rate_), &MantisGuidanceBase::callback_timer, this );
...
void MantisGuidanceBase::callback_cfg_control_settings(mantis_guidance_base::ControlParamsConfig &config, uint32_t level) {
...
Eigen::Affine3d MantisGuidanceBase::calc_goal_base_transform(const Eigen::Affine3d &ge_sp, const Eigen::Affine3d &gbe) {
...
Eigen::Vector3d MantisGuidanceBase::calc_goal_base_velocity(const Eigen::Vector3d &gev_sp, const Eigen::Matrix3d &Re, const Eigen::VectorXd &vbe) {
