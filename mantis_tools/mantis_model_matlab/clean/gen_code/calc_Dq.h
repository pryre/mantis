...
inline void calc_Dq(Eigen::MatrixXd& Dq, double IJ0x, double IJ0y, double IJ0z, double IJ1x, double IJ1y, double IJ1z, double IJ2x, double IJ2y, double IJ2z, double l1, double l2, double m0, double m1, double m2, double r1, double r2) {
	...
	Dq(6,3) = l1*m1*sin(r1)*(-1.0/2.0)-l1*m2*sin(r1)+IJ2y*l2*sin(r1+r2)*(1.0/2.0)-l2*m2*sin(r1+r2)*(1.0/2.0)+IJ1y*l1*sin(r1)*(1.0/2.0)+IJ2y*l1*sin(r1);
	Dq(7,3) = IJ2y*(l2*sin(r1+r2)*(1.0/2.0)+l1*sin(r1))-l2*m2*sin(r1+r2)*(1.0/2.0);
	...
	Dq(6,5) = l1*m1*cos(r1)*(-1.0/2.0)-l1*m2*cos(r1)+IJ2y*l2*cos(r1+r2)*(1.0/2.0)-l2*m2*cos(r1+r2)*(1.0/2.0)+IJ1y*l1*cos(r1)*(1.0/2.0)+IJ2y*l1*cos(r1);
	Dq(7,5) = IJ2y*(l2*cos(r1+r2)*(1.0/2.0)+l1*cos(r1))-l2*m2*cos(r1+r2)*(1.0/2.0);
	Dq(1,6) = IJ1y+IJ2y;
	Dq(3,6) = l1*m1*sin(r1)*(-1.0/2.0)-l1*m2*sin(r1)+IJ2y*l2*sin(r1+r2)*(1.0/2.0)-l2*m2*sin(r1+r2)*(1.0/2.0)+IJ1y*l1*sin(r1)*(1.0/2.0)+IJ2y*l1*sin(r1);
	Dq(5,6) = l1*m1*cos(r1)*(-1.0/2.0)-l1*m2*cos(r1)+IJ2y*l2*cos(r1+r2)*(1.0/2.0)-l2*m2*cos(r1+r2)*(1.0/2.0)+IJ1y*l1*cos(r1)*(1.0/2.0)+IJ2y*l1*cos(r1);
	Dq(6,6) = IJ1y+IJ2y+(l1*l1)*m1*(1.0/4.0)+(l1*l1)*m2+(l2*l2)*m2*(1.0/4.0)+l1*l2*m2*cos(r2);
	Dq(7,6) = IJ2y+l2*m2*(l2*(1.0/2.0)+l1*cos(r2))*(1.0/2.0);
	Dq(1,7) = IJ2y;
	Dq(3,7) = IJ2y*(l2*sin(r1+r2)*(1.0/2.0)+l1*sin(r1))-l2*m2*sin(r1+r2)*(1.0/2.0);
	Dq(5,7) = IJ2y*(l2*cos(r1+r2)*(1.0/2.0)+l1*cos(r1))-l2*m2*cos(r1+r2)*(1.0/2.0);
	Dq(6,7) = IJ2y+l2*m2*(l2*(1.0/2.0)+l1*cos(r2))*(1.0/2.0);
	Dq(7,7) = IJ2y+(l2*l2)*m2*(1.0/4.0);
}
