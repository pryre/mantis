...
class Router {
	private:
		...
		dynamic_reconfigure::Server<mantis_router_full::ControlParamsConfig> dyncfg_control_settings_;

		std::vector<MantisRouterFull::Joint*> joint_routers_;
	...
	public:
		...
		void callback_cfg_control_settings(mantis_router_full::ControlParamsConfig &config, uint32_t level);
