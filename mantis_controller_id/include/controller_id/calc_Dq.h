...
inline void calc_Dq(Eigen3::MatrixXd& m, double IJ1x, double IJ1y, double IJ1z, double IJ2x, double IJ2y, double IJ2z, double IT0x, double IT0y, double IT0z, double l1, double l2, double m0, double m1, double m2, double r1, double r2) {
