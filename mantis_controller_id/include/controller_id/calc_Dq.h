...
inline void calc_Dq(Eigen::MatrixXd& m, double IJ0x, double IJ0y, double IJ0z, double IJ1x, double IJ1y, double IJ1z, double IJ2x, double IJ2y, double IJ2z, double l1, double l2, double m0, double m1, double m2, double r1, double r2) {
	m(0,0) = IJ0x+IJ2x*pow(cos(r1+r2),2.0)+IJ2z*pow(sin(r1+r2),2.0)+IJ1x*pow(cos(r1),2.0)+IJ1z*pow(sin(r1),2.0);
	...
	m(2,2) = IJ0z+IJ2z*pow(cos(r1+r2),2.0)+IJ2x*pow(sin(r1+r2),2.0)+IJ1z*pow(cos(r1),2.0)+IJ1x*pow(sin(r1),2.0);
