...
InterfaceDynamixel::InterfaceDynamixel()
	...
	// 10, &InterfaceDynamixel::callback_setpoints, this );
	...
	if ( port_ok ) {
		...
		if ( add_motors() ) {
			...
			timer_ = nhp_.createTimer( ros::Duration( 1.0 / param_update_rate_ ),
				&InterfaceDynamixel::callback_timer, this );
			srv_enable_torque_specific_ = nhp_.advertiseService(
				"enable_torque_specific", &InterfaceDynamixel::enable_torque_specific,
				this );
			srv_enable_torque_all_ = nhp_.advertiseService(
				"enable_torque_all", &InterfaceDynamixel::enable_torque_all, this );
...
bool InterfaceDynamixel::enable_torque_specific(
	mantis_interface_dynamixel::EnableTorque::Request& req,
	mantis_interface_dynamixel::EnableTorque::Response& res ) {
	bool success = true;
...
bool InterfaceDynamixel::enable_torque_all( std_srvs::SetBool::Request& req,
...
void InterfaceDynamixel::init_motor( std::string motor_model, uint8_t motor_id,
...
/*
void InterfaceDynamixel::callback_setpoints(const
