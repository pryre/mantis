...
InterfaceJoint::InterfaceJoint( const ros::NodeHandle& nh, std::string joint_name, double ref_timeout_ ) :
	...
	sub_reference_pos_ = nh_.subscribe<std_msgs::Float64>( "reference/position", 10, &InterfaceJoint::callback_reference_pos, this);
	sub_reference_vel_ = nh_.subscribe<std_msgs::Float64>( "reference/velocity", 10, &InterfaceJoint::callback_reference_vel, this);
	sub_reference_eff_ = nh_.subscribe<std_msgs::Float64>( "reference/effort", 10, &InterfaceJoint::callback_reference_eff, this);
}

InterfaceJoint::~InterfaceJoint() {
}

void InterfaceJoint::callback_reference_pos( const std_msgs::Float64::ConstPtr& msg_in ) {
	ref_pos_ = msg_in->data;
	current_ref_ = InterfaceJoint::CurrentReference::Position;
	ref_update_t_ = ros::Time::now();
}

void InterfaceJoint::callback_reference_vel( const std_msgs::Float64::ConstPtr& msg_in ) {
	ref_vel_ = msg_in->data;
	current_ref_ = InterfaceJoint::CurrentReference::Velocity;
	ref_update_t_ = ros::Time::now();
}

void InterfaceJoint::callback_reference_eff( const std_msgs::Float64::ConstPtr& msg_in ) {
