...
ControllerFeed::ControllerFeed() :
	...
	dyncfg_control_settings_.setCallback(boost::bind(&ControllerFeed::callback_cfg_control_settings, this, _1, _2));
	...
	if( p_.wait_for_params() && s_.wait_for_state() ) {
		...
		sub_state_attitude_target_ = nhp_.subscribe<mavros_msgs::AttitudeTarget>( "command/attitude", 10, &ControllerFeed::callback_state_attitude_target, this );
		...
		timer_est_ = nhp_.createTimer(ros::Duration(1.0/param_est_rate_), &ControllerFeed::callback_est, this );
...
void ControllerFeed::callback_cfg_control_settings(mantis_controller_feed::ControlParamsConfig &config, uint32_t level) {
...
void ControllerFeed::callback_state_attitude_target(const mavros_msgs::AttitudeTarget::ConstPtr& msg_in) {
